...
//                             <div
//                                 key={task._id}
//                                 className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between"
//                             >
//                                 <div>
//                                     <div className="flex justify-between items-start gap-3">
//                                         <h3 className="font-semibold text-slate-900 leading-snug">{task.title}</h3>
//                                         <span className={`shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${statusStyles[task.status]}`}>
...
//                                             className="text-slate-400 hover:text-rose-600 text-sm font-medium"
//                                         >
//                                             Delete
//                                         </button>
//                                     </div>
